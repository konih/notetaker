...
| Audio | `AUDIO_CHUNK_SECONDS`, `AUDIO_SAMPLE_RATE`, `AUDIO_CHANNELS`, `AUDIO_STEREO_MODE`, `AUDIO_INCLUDE_MICROPHONE`, `AUDIO_MACOS_SYSTEM_CAPTURE`, `AUDIO_SILENCE_SKIP_ENABLED`, `AUDIO_SILENCE_THRESHOLD_DBFS` |
| Offline speakers | `HF_TOKEN`, `WHISPERX_*`, `FINALIZE_ON_SESSION_STOP`, `OFFLINE_ASR_ENGINE`, `MLX_WHISPER_MODEL`, `MLX_SILENCE_GATE_DBFS` |
